class FullStackedBarChart {
    ...
    drawRects() {
        ...
        for (let i = 0; i < this.data.length; i++) {
            ...
            noStroke();
            rect((this.barWidth + this.spacing) * i, 0, this.barWidth, (this.scaleData(-this.data[i].values[j]) / this.data[i].total) * this.chartHeight);
            translate(0, (this.scaleData(-this.data[i].values[j]) / this.data[i].total) * this.chartHeight);
            }
            pop();
